...
function countdown() {
	...
	function appStart() {
		...
		this.theCanvas = document.getElementById('countdown-canvas');
	...
	function fireLight(t) {
		...
		if (t == 120) {
			console.log("yellow");
			currentLight.gradient(0, 255, 0, 255, 255, 0, 300);
		} else {
			if (t == 60) {
				console.log("red");
				currentLight.gradient(255, 255, 0, 255, 0, 0, 300);
			} else {
				if (t <= 30) {
					console.log("flashing");
					if ((t % 2) == 0) {
						currentLight.gradient(255, 0, 0, 0, 0, 0, 45);
					} else {
						currentLight.gradient(0, 0, 0, 255, 0, 0, 45);
					}
				}
			}
		}
